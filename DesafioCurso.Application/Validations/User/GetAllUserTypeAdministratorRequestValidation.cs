...
{
    public class GetAllUserTypeAdministratorRequestValidation : AbstractValidator<GetAllUserTypeAdministratorRequest>
    {
        public GetAllUserTypeAdministratorRequestValidation()
        {
